...
# Create Backends
serve.create_backend(echo1, "echo:v1_1",num_gpu=0)
serve.create_backend(echo1, "echo:v1_2",num_gpu=0)
...
'''
Two replica's for the service serve1. 
'''
serve.link_service("serve1", "echo:v1_1")
serve.link_service("serve1", "echo:v1_2")
...
'''
'''
Creating a pipeline serve1 -> serve2 
'''
